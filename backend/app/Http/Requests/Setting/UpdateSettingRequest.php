...
class UpdateSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'address_line1_ms' => ['sometimes', 'nullable', 'string', 'max:255'],
            'address_line2' => ['sometimes', 'nullable', 'string', 'max:255'],
            'address_line2_ms' => ['sometimes', 'nullable', 'string', 'max:255'],
            'postcode' => ['sometimes', 'nullable', 'string', 'max:20'],
            'city' => ['sometimes', 'nullable', 'string', 'max:255'],
            'city_ms' => ['sometimes', 'nullable', 'string', 'max:255'],
            'state' => ['sometimes', 'nullable', 'string', 'max:255'],
            'state_ms' => ['sometimes', 'nullable', 'string', 'max:255'],

            'contact_phone' => ['sometimes', 'nullable', 'string', 'max:30'],
            'contact_email' => ['sometimes', 'nullable', 'email', 'max:255'],
            'operating_hours' => ['sometimes', 'nullable', 'string', 'max:255'],
            'operating_hours_ms' => ['sometimes', 'nullable', 'string', 'max:255'],
